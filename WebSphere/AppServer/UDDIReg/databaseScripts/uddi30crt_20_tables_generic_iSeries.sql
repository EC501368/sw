-- Path, Component, Release:  UDDI/ws/code/uddi.install/src/database/uddi30crt_20_tables_generic_iSeries.sql, UDDI, WAS855.UDDI, cf091607.02
-- Version:                   1.1
-- Last-changed:              05/07/18 10:42:28
--
...
create table ibmudi30.business(
    businesskey      char(36)        not null,
    name             vargraphic(765)CCSID 13488,
...
create table ibmudi30.businessname(
    ...
    name            vargraphic(765)CCSID 13488    not null,
...
create table ibmudi30.contact(
    ...
    businesskey     char(36)        not null,
    seqnum          integer         not null,
    usetype         vargraphic(765)CCSID 13488
);

create table ibmudi30.contactdescr(
    parentkey      char(36)        not null,
    seqnum         integer         not null,
    description    vargraphic(765)CCSID 13488   not null,
    lang           varchar(26)
);
...
create table ibmudi30.personname(
    contactkey     char(36)        not null,
    seqnum         integer         not null,
    personname     vargraphic(765)CCSID 13488    not null,
    lang           varchar(26)
);
...
create table ibmudi30.email(
    contactkey     char(36)        not null,
    seqnum         integer         not null,
    emailaddr      vargraphic(765)CCSID 13488    not null,
    usetype        vargraphic(765)CCSID 13488
);
...
create table ibmudi30.phone(
    contactkey     char(36)        not null,
    seqnum         integer         not null,
    phone          vargraphic(765)CCSID 13488    not null,
    usetype        vargraphic(765)CCSID 13488
);
...
create table ibmudi30.address(
    ...
    seqnum         integer         not null,
    adtmodelkey    char(36),
    sortcode       vargraphic(30)CCSID 13488,
    lang           varchar(26),
    usetype        vargraphic(765)CCSID 13488
);
...
create table ibmudi30.addrline(
    addresskey    char(36)        not null,
    seqnum        integer         not null,
    keyname       vargraphic(765)CCSID 13488,
    keyvalue      vargraphic(765)CCSID 13488,
    addressline   vargraphic(240)CCSID 13488    not null
);
...
create table ibmudi30.businesscatbag(
    ...
    keyname           vargraphic(765)CCSID 13488,
    keyvalue          vargraphic(765)CCSID 13488    not null,
...
create table ibmuds30.tier(
    tierid          integer        not null,
    name            vargraphic(255)CCSID 13488   not null,
    description     vargraphic(765)
);
