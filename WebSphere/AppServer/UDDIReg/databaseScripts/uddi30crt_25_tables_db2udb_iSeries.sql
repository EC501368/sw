-- Path, Component, Release:  UDDI/ws/code/uddi.install/src/database/uddi30crt_25_tables_db2udb_iSeries.sql, UDDI, WAS855.UDDI, cf091607.02
-- Version:                   1.2
-- Last-changed:              06/01/24 09:03:25
--
...
create table ibmudi30.discoveryurl(
    ...
    url               vargraphic(12288)CCSID 13488    not null,
...
create table ibmudi30.btemplate(
    ...
    accesspoint       vargraphic(6144)CCSID 13488,
    usetype           varchar(765),
...
create table ibmudi30.tminstanceinfo(
    ...
    instanceparms     vargraphic(16000)CCSID 13488,
    seqnum            integer           not null
);
...
create table ibmudi30.idoviewdoc(
    ...
    seqnum            integer           not null,
    overviewurl       vargraphic(12288)CCSID 13488,
    usetype           varchar(765)
);
