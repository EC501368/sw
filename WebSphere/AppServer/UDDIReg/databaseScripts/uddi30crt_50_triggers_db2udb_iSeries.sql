-- Path, Component, Release:  UDDI/ws/code/uddi.install/src/database/uddi30crt_50_triggers_db2udb_iSeries.sql, UDDI, WAS855.UDDI, cf091607.02
-- Version:                   1.1
-- Last-changed:              05/07/18 10:43:10
--
...
--==========================================================
-- Defect   ID   Developer     Error
-- 260226  @DLH1 Dan Hiebert   Delete Cascade Trigger not supported on iSeries.
--==========================================================
--
-- Business triggers
--
...
-- delete
-- begin @DLH1
-- Removed by Defect 260226
-- Delete Cascade Trigger not supported on iSeries DB2
--
