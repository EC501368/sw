...
# *******************************************************************
# * IMPORTANT:
# * This tool is meant to be run only during uninstall. It is not
# * meant for customer use. To uninstall WebSphere, use the
# * WebSphere uninstall program. To remove a node from a cell, use
# * the removeNode program.
# *******************************************************************

APP_EXT_ID=com.ibm.ws.admin.services.NodeUninstallPrep
...
#Common args...
C_PATH="$WAS_CLASSPATH":$CLASSPATH
