...
CLASS_NAME=org.apache.openjpa.enhance.PCEnhancer

BIN_DIR=`dirname $0`
. "${BIN_DIR}/setupCmdLine.sh"

PROVIDER_CLASSPATH=${WAS_HOME}/dev/JavaEE/j2ee.jar:${WAS_HOME}/plugins/com.ibm.ws.jpa.jar:${WAS_HOME}/plugins/com.ibm.ws.prereq.commons-collections.jar:${WAS_HOME}/plugins/com.ibm.ws.prereq.ow.asm.jar
